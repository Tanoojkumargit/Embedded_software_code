...
#define Vibratation_Sen_Pin GPIO_PIN_2
#define Vibratation_Sen_GPIO_Port GPIOC
...
#define V_Sen_M1_Pin GPIO_PIN_5
#define V_Sen_M1_GPIO_Port GPIOC
#define Comp_1_Pin GPIO_PIN_0
#define Comp_1_GPIO_Port GPIOB
#define Comp_2_Pin GPIO_PIN_1
#define Comp_2_GPIO_Port GPIOB
...
extern volatile uint8_t low_voltage_flag;
