...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOC, Current_Sen_M1_Pin|Temp_ref_Pin|Vibratation_Sen_Pin|Temp_Sen_Pin
                          |MQ_7_Pin|V_Sen_M1_Pin);

    HAL_GPIO_DeInit(GPIOA, Phase_1_Pin|Phase_2_Pin|Phase_3_Pin|Mains_Ref_Pin
                          |MQ_135_Pin|MQ_2_Pin);

    HAL_GPIO_DeInit(GPIOB, Comp_1_Pin|Comp_2_Pin);
